      ...
      <div className="relative overflow-hidden bg-white py-16">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-prose text-lg">
            <h1>
              <span className="block text-center text-lg font-semibold text-indigo-600">MarvCleaning</span>
              <span className="mt-2 block text-center text-3xl font-bold leading-8 tracking-tight text-gray-900 sm:text-4xl">
             {`TRUST & SAFETY`}
              </span>
            </h1>
            <p className="mt-8 text-xl leading-8 text-gray-500">
           {` It’s always important to feel secure when you invite someone into your home.
            That’s why MarvCleaning takes extra steps to ensure that our clients can trust 
            us and know that their home will be safe in our hands. We are fully insured and bonded,
            so you can rest assured that any damage done to your property while we are there will be covered by us.`}
            </p>
          </div>
          <div className="prose prose-lg prose-indigo mx-auto mt-6 text-gray-500">
            <h3>
          <span className="mt-2 block text-center text-2xl font-bold leading-8 tracking-tight text-gray-500 sm:text-2xl">
             {`TRUST & SAFETY`}
              </span>
            </h3>
