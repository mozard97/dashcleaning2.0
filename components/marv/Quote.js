...
export default function Quote({ _id }) {
                        ...
                        <div className="relative">
                            <div className="sm:text-center">
                                ...
                                <p className="mx-auto mt-6 max-w-2xl text-lg text-indigo-200">
                                    Enter your phone number to get a free quote for your Home needs.
                                </p>
                            </div>
                            <form onSubmit={async (e) => {
                                e.preventDefault();
                                setLoading(true)
                                await fetch("/api/services/quote", {
                                    method: "POST",
                                    body: JSON.stringify({ phone, _id }),
                                ...
                                <div className="min-w-0 flex-1">
                                    <label htmlFor="cta-quote" className="sr-only">
                                        quote
                                    </label>
                                    <input
                                        id="cta-quote"
                                ...
                                <div className="mt-4 sm:mt-0 sm:ml-3">
                                    <button
                                        type="submit"
                                        disabled={loading || msz == "Done" || msz == "Failed"}
                                    ...
                                    >
                                        {msz == "Done" ? "Done" : msz == "Failed" ? "Failed" : loading ? "Loading.." : "Get Quote"}
                                    </button>
                                </div>
                            </form>
                        </div>
